    ...
    <>
      ...
      >
        <Col span={22}>
          ...
          <SelectBar
            value={date}
            {...((service === "" || Object.keys(dateOptions).length === 0) && {
              disabled: true,
            })}
            color="#20274D"
          ...
          >
            Secure reservation (costs 2000 Naira)
          </Checkbox>
          ...
          <Button
            ...
            onClick={() => {
              if (isValid) {
                submitForm(name, email, service, time, paid).then(
                  (response) => {
                        ...
                        content: (
                          <div>
                            ...
                            {response.data.payment && (
                              <p>
                                You requested a secured reservation. Pay on
                                paystack{" "}
                                <a href={response.data.paymentUrl}>link</a>
                              </p>
                            )}
                            <p>
                              All details have been sent to your email. Thanks
                              for choosing Nolar.
                            </p>
                          </div>
                        ),
