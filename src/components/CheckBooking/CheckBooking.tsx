    ...
    <Row justify='center' style={{
      ...
      <Col span={20}>
        ...
        <div style={{
          ...
          <SingleInputBar buttonText='Check Booking' placeholder='Your reference number' onSubmit={(value) => {
      ...
      <Col span={20}>
        <Row justify={'start'}>
            <div style={{
              ...
              <h4 style={{fontWeight: 900, color: '#20274d'}}>Reservation Details</h4>
            </div>
            ...
            {state && <div style={{
              ...
              <div>
                ...
                <Text style={{textTransform: 'capitalize'}}>{state.service}</Text>
              </div>
              <div>
                <Text strong style={{
                  color: '#20274D'
                }}>Payment: </Text>
                {state.paymentStatus ? <AiOutlineCheck color='green'></AiOutlineCheck> : <AiOutlineClose color='red'></AiOutlineClose>}
              </div>
              <div>
                <Text strong style={{
                  color: '#20274D'
              ...
              <div style={{
                ...
                <Text style={{
                  fontSize: '48px'
                }}>{state.timeslot.toLocaleTimeString()}</Text>
              </div>
            </div>}
          <Col>
