...
export const CustomSection: FC<{
  ...
  return (
    ...
    <Row style={xxl ? xxlRowStyle : lg ? lgRowStyle : {
      ...
      <Col xs={{span: 20, offset: 2}} sm={{span: 20, offset: 2}} lg={{span: 10, offset: 2}} style={lg ? lgColStyle : {minHeight: '360px'}}>
      ...
      <Col 
        ...
        style={{
          ...lg ? lgColStyle : xsColStyle
            ...
            <Row justify={xs ? 'center' : 'start'} align='middle' style={{height: '100%'}}>
              <Col span={20} style={{
                display: 'flex',
    ...
    <Row style={xxl ? xxlRowStyle : lg ? lgRowStyle : {
      ...
      <Col xs={{span: 20, offset: 2}} sm={{span: 18, offset: 3}} lg={{span: 10, offset: 2}} order={!lg ? 1 : 0} style={lg ? lgColStyle : {minHeight: '360px'}}>
        <Row justify={lg ? 'start' : 'center'} align='middle' style={{height: '100%'}}>
          <Col>
            {props.image}
          </Col>
